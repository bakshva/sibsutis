...
/* Block (tail) size */
#define BS 512  //(CACHELINE_SIZE / sizeof(double))

double a[N][N];  __attribute__ ((aligned(CACHELINE_SIZE)));
double b[N][N];  __attribute__ ((aligned(CACHELINE_SIZE)));
double c[N][N];  __attribute__ ((aligned(CACHELINE_SIZE)));
